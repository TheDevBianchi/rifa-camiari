...
const TicketSelectionSection = ({
  ...
  useEffect(() => {
    ...
    const discountedTotal = selectedPromotion
      ? calculateTotal(ticketCount)
      : regularTotal;
  ...
  const handleValidateCreatorCode = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.success(
          `¡Código aplicado! ${result.promotion.discountValue}% de descuento`
        );
      } else {
        setCodeValidationResult({
          valid: false,
  ...
  return (
    <div className="space-y-6 bg-black/40 p-6 mb-8 rounded-xl border border-primary-500/10 hover:border-primary-500/30 transition-all duration-300 hover:shadow-[0_0_15px_rgba(140,82,255,0.1)]">
      <div className="flex items-center justify-between">
        <h2 className="text-xl text-primary-500 font-bold flex items-center gap-2">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="bg-black/50 border-gray-700/50 focus-visible:ring-primary-500/50 transition-colors ring-black"
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button
              ...
              onClick={() => {
                ...
                setValue("selectedTickets", Array(3).fill(""), {
                  shouldValidate: true,
                });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                ...
                setValue("selectedTickets", Array(5).fill(""), {
                  shouldValidate: true,
                });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                ...
                setValue("selectedTickets", Array(10).fill(""), {
                  shouldValidate: true,
                });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                ...
                setValue("selectedTickets", Array(15).fill(""), {
                  shouldValidate: true,
                });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                ...
                setValue("selectedTickets", Array(20).fill(""), {
                  shouldValidate: true,
                });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                ...
                setValue("selectedTickets", Array(50).fill(""), {
                  shouldValidate: true,
                });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                ...
                setValue("selectedTickets", Array(100).fill(""), {
                  shouldValidate: true,
                });
              }}
            >
          ...
          <div className="mt-4 pt-4 border-t border-gray-700">
            <div className="flex justify-between items-center mb-3">
              ...
              {selectedPromotion ? (
                ...
                <span className="text-xs text-gray-400 italic">
                  Selecciona una promoción o usa un código
                </span>
              )}
            </div>
            ...
            <div className="p-3 rounded-lg border border-primary-500/30 bg-black/50 hover:border-primary-500/50 transition-all duration-300 mb-3">
              ...
              <div className="mt-2 flex gap-2">
                <Input
                  ...
                  disabled={
                    ...
                    (selectedPromotion &&
                      selectedPromotion.discountType !== "creator_code")
                  }
                />
                ...
                {codeValidationResult?.valid ? (
                  <Button
                    type="button"
                    variant="outline"
                    className="border-secondary-500/30 text-secondary-400 hover:bg-secondary-500/10 hover:text-secondary-300 transition-all duration-300"
                    onClick={() => {
                      setCreatorCode("");
                      setCodeValidationResult(null);
                      setSelectedPromotion(null);
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="border-primary-500/30 text-primary-400 hover:bg-primary-500/10 hover:text-primary-300 transition-all duration-300"
              ...
              {codeValidationResult && (
                <div
                  className={`mt-2 text-sm flex items-center gap-1 ${codeValidationResult.valid ? "text-green-400" : "text-secondary-400"}`}
                >
                  {codeValidationResult.valid ? (
                    <>
                      ...
                      <span>
                        ¡Código aplicado!{" "}
                        {codeValidationResult.promotion.discountValue}% de
                        descuento
                      </span>
                    </>
                  ) : (
            ...
            <div className="bg-primary-900/20 border border-primary-500/30 rounded-md p-3 mb-3">
              <p className="text-xs text-primary-300">
                <span className="font-medium">Nota:</span> Solo puedes aplicar
                una promoción a la vez. Selecciona la que más te convenga.
              </p>
            </div>
            ...
            <div className="space-y-2">
              {promotions &&
                promotions
                  .filter(
                    (promo) =>
                      promo.active && promo.discountType !== "creator_code"
                  )
                  .map((promo) => (
                    <div
                      key={promo.id}
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-1">
                          {bestPromoId === promo.id && (
                            <span className="text-xs bg-primary-900/70 text-primary-300 px-2 py-0.5 rounded-full">
                              Mejor oferta
                            </span>
                          )}
                          {selectedPromotion?.id === promo.id && (
                      ...
                      <div className="text-sm text-gray-300 mt-1 flex items-center">
                        {promo.discountType === "percentage" && (
                          <>
                            <Percent className="w-3.5 h-3.5 mr-1 text-primary-400" />
                            <span>{promo.discountValue}% de descuento</span>
                          </>
                        )}
                        {promo.discountType === "lower_cost" && (
                          <>
                            <ArrowDownCircle className="w-3.5 h-3.5 mr-1 text-secondary-400" />
                            <span>
                              Precio reducido: ${promo.newTicketPrice} por
                              ticket
                            </span>
                          </>
                        )}
                        {promo.discountType === "package" && (
                          <>
                            <Package className="w-3.5 h-3.5 mr-1 text-primary-400" />
                            <span>
                              {promo.minTickets} tickets por $
                              {promo.packagePrice}
                            </span>
                          </>
                        )}
              ...
              {(!promotions ||
                ...
                <p className="text-sm text-gray-400 italic">
                  No hay otras promociones disponibles
                </p>
              )}
            </div>
          </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedTickets.includes(number)
                      ? "bg-primary text-white shadow-[0_0_10px_rgba(140,82,255,0.3)]"
          ...
          <div className="mt-4 pt-4 border-t border-gray-700">
            <div className="flex justify-between items-center mb-3">
              ...
              {selectedPromotion ? (
                ...
                <span className="text-xs text-gray-400 italic hover:cursor-pointer">
                  Selecciona una promoción o usa un código
                </span>
              )}
            </div>
            ...
            {promotions &&
              promotions.filter(
                (promo) => promo.active && promo.discountType !== "creator_code"
              ).length > 0 && (
                <>
                  <div className="bg-primary-900/20 border border-primary-500/30 rounded-md p-3 mb-3">
                    <p className="text-xs text-primary-300">
                      <span className="font-medium">Nota:</span> Solo puedes
                      aplicar una promoción a la vez. Selecciona la que más te
                      convenga.
                    </p>
                  </div>
